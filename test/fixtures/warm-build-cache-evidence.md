...
```text
#49 [stage-2 35/45] RUN openclaw plugins install --force --accept-capabilities /opt/nemoclaw ...
#49 DONE 3.7s
...
```text
#57 [stage-2 35/45] RUN openclaw plugins install --force --accept-capabilities /opt/nemoclaw ...
#57 CACHED
