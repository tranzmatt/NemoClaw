...
- [Manage Sandbox Lifecycle](../manage-sandboxes/lifecycle#uninstall).
...
- [Manage Sandbox Lifecycle](../manage-sandboxes/lifecycle#uninstall) for the generic uninstall flow.
- [Backup and Restore](../manage-sandboxes/backup-restore) before removing state you may need later.
