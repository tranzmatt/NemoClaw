...
The first API version supports Hermes `0.20.6` with OpenShell `0.0.116`.
...
An OpenShell release after `0.0.116` requires separate compatibility evidence before a later API definition can support it.
