...
If a semantic health response completed before startup failed, the error identifies the last request outcome, HTTP status, duration, and captured body size.
