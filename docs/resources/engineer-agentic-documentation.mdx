...
- The root `AGENTS.md` defines repository-wide success criteria, product scope, documentation impact, and independent review.
- `docs/AGENTS.md` defines the documentation-agent role, DORI routing, skill selection, and task workflow.
- `docs/CONTRIBUTING.md` defines public documentation rules, navigation, release procedures, and validation.
