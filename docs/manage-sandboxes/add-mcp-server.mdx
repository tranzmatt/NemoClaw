...
NemoClaw pins the child-visible compatibility list to OpenShell `v0.0.101` commit `8ddd98c3dff62619a3963f99ba1e055b67650e72`.
...
OpenShell `v0.0.101` has a trusted-gateway branch for a narrow driver-provided topology, but it does not expose an attested driver gateway address that NemoClaw can pin for this flow.
